...
set_target_properties(Poco::OSP PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libPocoOSP.so.71"
  IMPORTED_SONAME_RELWITHDEBINFO "libPocoOSP.so.71"
  )

list(APPEND _IMPORT_CHECK_TARGETS Poco::OSP )
list(APPEND _IMPORT_CHECK_FILES_FOR_Poco::OSP "${_IMPORT_PREFIX}/lib/libPocoOSP.so.71" )
